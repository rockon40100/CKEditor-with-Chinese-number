...
* Added new translation: Occitan. Thanks to [C矇dric Valmary](https://totenoc.eu/)!
...
* [#13434](http://dev.ckeditor.com/ticket/13434): Fixed: Dialog state indicator broken in Right?o?eft environments.
...
* [#12739](http://dev.ckeditor.com/ticket/12739): Fixed: Link loses inline styles when edited without the [Advanced Tab for Dialogs](http://ckeditor.com/addon/dialogadvtab) plugin. Thanks to [???訄郅?邿 ?????郕郋](https://github.com/asmforce)!
* [#13292](http://dev.ckeditor.com/ticket/13292): Fixed: Protection pattern does not work in attribute in self-closing elements with no space before `/>`. Thanks to [???訄郅?邿 ?????郕郋](https://github.com/asmforce)!
