				...
				title:
					...
					contents:[	{
						...
						elements:[{
							...
							setup:function(a){
								a=a.getStyle("list-style-type")||h[a.getAttribute("type")]||a.getAttribute("type")||"";
								this.setValue(a)
							},
							commit:function(a){
								var b=this.getValue();
									...
									elements:[{
										...
										children:[{
											...
											commit:function(a){
												...
												var d=parseInt(this.getValue(),10);isNaN(d)?a.removeAttribute("start"):a.setAttribute("start",d);
												a=b;
												b=c;
